...
class TestPygameUIInteraction(BasePygameTest):
    ...
    def test_get_point_from_coordinates_top_left(self):
        ...
        point = self.board.interaction.get_point_from_coordinates(
            x,
            y,
            self.board.play_area_x,
            self.board.play_area_y,
            self.board.play_area_width,
    ...
    def test_can_select_checker_own_piece(self):
        ...
        result = self.board.interaction.can_select_checker(0)
    ...
    def test_cannot_select_checker_opponent_piece(self):
        ...
        result = self.board.interaction.can_select_checker(23)
        self.assertFalse(result)

    def test_cannot_select_checker_empty_point(self):
        """Test cannot select from empty point."""
        result = self.board.interaction.can_select_checker(10)  # Empty point
        self.assertFalse(result)
    ...
    def test_get_valid_destinations_with_dice(self):
        ...
        destinations = self.board.interaction.get_valid_destinations(0)
    ...
    def test_get_valid_destinations_no_game(self):
        ...
        self.board.interaction.game = None
        destinations = self.board.interaction.get_valid_destinations(0)
    ...
    def test_select_checker(self):
        ...
        self.board.interaction.select_checker(0)

        self.assertEqual(self.board.interaction.selected_point, 0)
        self.assertIsNotNone(self.board.interaction.valid_destinations)
    ...
    def test_select_invalid_checker_no_change(self):
        ...
        self.board.interaction.select_checker(10)  # Empty point

        self.assertIsNone(self.board.interaction.selected_point)
    ...
    def test_deselect_checker(self):
        ...
        self.board.interaction.deselect_checker()

        self.assertIsNone(self.board.interaction.selected_point)
        self.assertIsNone(self.board.interaction.valid_destinations)
    ...
    def test_execute_move_valid(self):
        ...
        if self.game.validate_move(from_point, to_point):
            result = self.board.interaction.execute_checker_move(from_point, to_point)
            self.assertTrue(result)
    ...
    def test_execute_move_invalid(self):
        ...
        result = self.board.interaction.execute_checker_move(0, 20)
        self.assertFalse(result)
    ...
    def test_execute_move_deselects_checker(self):
        ...
        self.board.interaction.select_checker(from_point)

        if self.game.validate_move(from_point, to_point):
            self.board.interaction.execute_checker_move(from_point, to_point)
            self.assertIsNone(self.board.interaction.selected_point)
