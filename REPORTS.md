...
core/backgammon.py          426     53    88%   123, 202, 247, 300, 344, 355, 376, 406, 445, 448, 472, 477, 481, 485, 492, 507, 512, 516-529, 539-549, 558, 634, 644-646, 650-655, 662-668
...
core/backgammon.py:392:8: R1705: Unnecessary "elif" after "return", remove the leading "el" from "elif" (no-else-return)
core/backgammon.py:412:8: R1705: Unnecessary "elif" after "return", remove the leading "el" from "elif" (no-else-return)
core/backgammon.py:494:15: R1716: Simplify chained comparison between the operands (chained-comparison)
core/backgammon.py:522:19: R1716: Simplify chained comparison between the operands (chained-comparison)
core/backgammon.py:523:20: R1705: Unnecessary "elif" after "return", remove the leading "el" from "elif" (no-else-return)
core/backgammon.py:500:4: R0911: Too many return statements (8/6) (too-many-return-statements)
core/backgammon.py:500:4: R0912: Too many branches (22/12) (too-many-branches)
core/backgammon.py:538:8: R1702: Too many nested blocks (6/5) (too-many-nested-blocks)
************* Module core.board
